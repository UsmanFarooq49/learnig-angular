        ...
        <div class="bg-surface-50 dark:bg-surface-950 flex items-center justify-center min-h-screen min-w-screen overflow-hidden">
            <div class="flex flex-col items-center justify-center">
                <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 150, 243, 0) 30%)">
                    ...
                    <div *ngIf="error$ | async as error" class="p-4 mb-4 text-red-700 bg-red-100 rounded-lg dark:bg-red-200 dark:text-red-800">
                    ...
                    <div>
                        ...
                        <p-button label="Sign In" styleClass="w-full" (onClick)="login()" [loading]="(loading$ | async) ?? false"></p-button>
                    </div>
                </div>
            </div>
        </div>
